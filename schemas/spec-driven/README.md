...
называет ни одного теста, и артефакт с ним не готов. Снимает заготовку
автор: `--strict` этой версии требует у требования хотя бы один Scenario и
написанный Purpose, а текст заготовки для него неотличим от написанного.
