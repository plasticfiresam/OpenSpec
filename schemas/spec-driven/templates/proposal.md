...
таким, каким он уже существует в каталоге спецификаций проекта (в терминах
OpenSpec — exact existing path under openspec/specs/). Оставьте пусто, если
требования не меняются. Change вообще без возможностей (чистый рефакторинг, инструменты,
